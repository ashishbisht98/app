      ...
      <div className="relative mx-auto max-w-[1500px] xs:px-6 sm:px-6 md:px-6 py-16 md:py-16 lg:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center ">
          <div className="lg:col-span-6">
            ...
            <div className="mt-14 grid grid-cols-2 sm:grid-cols-3 border-t border-l border-grid rounded-xl overflow-hidden" data-testid="hero-stats">
              {[
                ...
                <div
                  key={s.k}
                  className="border-r border-b border-grid  py-5 px-4 flex flex-col items-start"
